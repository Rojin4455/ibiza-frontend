...
<div className="bg-white rounded-lg shadow-lg p-5 mb-8 border border-gray-100 sticky top-5 z-30">
      <div className="flex flex-col md:flex-row gap-4">
        ...
        {/* Filter Toggle Button with improved styling */}
        <button 
      ...
      {/* Expanded Filter Section with improved styling */}
      {showFilters && (
        <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Property Type with improved styling */}
            <div className="space-y-3">
            ...
            {/* Bedrooms with improved styling */}
            <div className="space-y-3">
              <label className="block text-sm font-medium text-gray-700 flex items-center">
            ...
            {/* Bathrooms with improved styling */}
            <div className="space-y-3">
              <label className="block text-sm font-medium text-gray-700 flex items-center">
            ...
            {/* Location with search and multi-select */}
...
{/* 
  <button
    ...
    className="px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-primary-dark rounded-lg shadow transition-colors duration-200"
  >
    Submit
  </button> */}
</div>
